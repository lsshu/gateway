# Generated by Django 3.0.6 on 2020-05-07 18:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumb', models.ImageField(upload_to='banner/', verbose_name='轮播图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumb', models.ImageField(blank=True, null=True, upload_to='category/%Y/%m', verbose_name='分类图片')),
                ('is_abort', models.BooleanField(default=False, verbose_name='是否删除')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
                ('modified_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('parent', models.ForeignKey(blank=True, default=0, limit_choices_to={'is_abort': False, 'is_root': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='blogs.BlogCategory', verbose_name='上级分类')),
            ],
            options={
                'verbose_name': '博客分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumb', models.ImageField(blank=True, null=True, upload_to='article_thumb/%Y/%m/%d/', verbose_name='文章图片')),
                ('body', models.TextField()),
                ('views', models.PositiveIntegerField(default=0, verbose_name='阅读量')),
                ('is_abort', models.BooleanField(default=False, verbose_name='是否删除')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
                ('modified_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blogs.BlogCategory', verbose_name='分类')),
                ('tags', models.ManyToManyField(blank=True, to='blogs.BlogTag', verbose_name='标签')),
                ('tui', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blogs.BlogTui', verbose_name='推荐位')),
